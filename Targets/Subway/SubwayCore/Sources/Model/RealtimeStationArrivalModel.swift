...
public struct RealtimeArrivalList: Codable {
  ...
  public init(totalCount: Int, rowNum: Int, subwayId: String, statnNm: String, trainLineNm: String, barvlDt: String, recptnDt: String, arvlMsg2: String, arvlMsg3: String, arvlCd: String) {
